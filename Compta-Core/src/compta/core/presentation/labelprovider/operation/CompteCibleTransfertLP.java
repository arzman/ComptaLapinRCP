...
public class CompteCibleTransfertLP extends CellLabelProvider {
	...
	public void update(final ViewerCell cell) {
		...
		if (cell.getElement() instanceof OperationIdentifier) {
			...
			try {
				txt = TrimestreManager.getInstance().getTransfertCompteCibleNom((OperationIdentifier) cell.getElement());
