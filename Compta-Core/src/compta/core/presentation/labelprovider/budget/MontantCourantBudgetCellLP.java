...
public class MontantCourantBudgetCellLP extends CellLabelProvider {
	...
	public void update(ViewerCell cell) {
		...
		try {
			final double montant = BudgetManager.getInstance().getMontantCourant((Identifier) cell.getElement());
